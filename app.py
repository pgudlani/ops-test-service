...
class BadTeamFilterError(ValueError):
    """Raised when filtering by a team that has no members in the dataset."""
    pass
...
def calculate_percentage(rows, team: str) -> float:
    ...
    if denominator == 0:
        raise BadTeamFilterError(f"Invalid team '{team}': no team members found")
